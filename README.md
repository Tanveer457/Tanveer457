# Hi there, I'm Tanveer Younas 👋

I am an Artificial Intelligence undergraduate student concluding my B.Sc. in AI at Pak-Austria Fachhochschule Institute of Applied Sciences and Technology (PAF-IAST), graduating in July 2026. 
...
*   **Computer Vision & Object Detection:** Custom architectural tuning, specifically working with the latest iterations of YOLO frameworks for specialized industrial environments.
...
### 🚀 Computer Vision-Based Fire Hazard Detection System (Undergraduate FYP)
*   **Objective:** Built an end-to-end real-time hazard monitoring pipeline tailored for harsh industrial settings.
...
├── Frameworks:      PyTorch, TensorFlow, OpenCV, Hugging Face
├── Machine Learning: Scikit-Learn, Pandas, NumPy
└── Hardware/Ops:    NVIDIA Jetson Nano, Linux, Git, Docker
